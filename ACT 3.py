...
# Part b: Use type function to identify the class
...
# Part c: Display list of methods using dir function
...
# Part d: Implement any five methods for each data type
